...
DB_URI = environ.get("DB_URI", "mongodb+srv://Tonystarkbotz:Tonystarkbotz@missminutes.lbzdtkj.mongodb.net/?retryWrites=true&w=majority")
...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002210669265"))
...
WEBSITE_URL = environ.get("WEBSITE_URL", "https://tonystarkbotz.blogspot.com/2024/08/tony-stark-botz.html") # For More Information Check Video On Yt - @Tech_VJ
